...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <Image
        src="/photos/fall-casting-scenic.jpg"
        alt="Fly fishing on a misty Tennessee river at sunrise — Trophy Fishing TN"
        fill
        priority
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 py-32 text-center sm:px-6 lg:px-8">
        <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-sunset-400 sm:text-base">
          Caney Fork &bull; Cumberland River &bull; Center Hill Lake
        </p>
        ...
        <h1 className="font-[family-name:var(--font-heading)] text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
          Trophy Fish.
          <span className="block mt-2 text-sunset-400">Trophy Photos.</span>
          <span className="block mt-2 text-white">Tennessee.</span>
        </h1>

        <p className="mx-auto mt-6 max-w-2xl text-lg text-lake-100 sm:text-xl md:text-2xl leading-relaxed">
          Guided fly fishing with Mike Anderson — 30+ years on Tennessee&apos;s
          finest rivers and lakes. Trout, striper, musky, smallmouth,
          and magazine-quality photography of every catch.
        </p>
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-8 text-lake-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium">Published Photographer</span>
          </div>
          <div className="flex items-center gap-2">
            <svg className="h-5 w-5 text-sunset-400" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
            </svg>
            <span className="text-sm font-medium">3-Boat Fleet</span>
          </div>
        </div>
      </div>
